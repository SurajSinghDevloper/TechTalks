<%-- 
    ...
    Created on : 19-Aug-2022, 1:06:39 pm
    Author     : suraj
--%>
...
<nav class="navbar navbar-expand-lg navbar-light  primary-background">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><a class="nav-link text-white" href="login_page.jsp"><span
                        class="	fa fa-external-link"></span>Login</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="register_page.jsp"><span
                        class="	fa fa-handshake-o"></span>Register</a></li>
        </ul>
